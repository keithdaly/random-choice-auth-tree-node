 ...
 */
public class RandomChoiceNodePlugin extends AbstractNodeAmPlugin {
	 ...
	 */
	@Inject
	public RandomChoiceNodePlugin(AnnotatedServiceRegistry serviceRegistry) {
